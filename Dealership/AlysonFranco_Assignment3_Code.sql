...
ALTER TABLE vehicles ADD year INT NOT NULL;
ALTER TABLE vehicles MODIFY COLUMN transmission varchar(40) NOT NULL;

INSERT INTO vehicles (make, model, year, retail, type, cylinders, engine, transmission, color, VIN, odometer) 
