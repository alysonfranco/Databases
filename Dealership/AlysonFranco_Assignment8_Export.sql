...
INSERT INTO `color` VALUES (17,'Agate Black'),(1,'Alpine White'),(11,'Antimatter Blue'),(20,'Black'),(7,'Black Sapphire'),(13,'Carbonized Gray'),(6,'Dravit Grey Metallic'),(21,'Grey'),(10,'Guard'),(15,'Iconic Silver'),(5,'Mediterranean Blue'),(8,'Mineral Grey'),(14,'Oxford White'),(2,'Potamaic Blue'),(16,'Rapid Red'),(18,'Red'),(12,'Space White'),(4,'Sunset Orange'),(3,'Tanzanite Blue'),(9,'Velocity Blue'),(19,'White');
...
INSERT INTO `sale` VALUES (1,14,3,40750.00),(2,30,32,26385.00),(3,8,15,30495.00),(5,18,21,26030.00),(8,12,8,32750.00),(10,31,35,19635.00);
...
INSERT INTO `type` VALUES (4,'Convertible'),(2,'Coupe'),(8,'Hatchback'),(1,'Sedan'),(9,'SUV'),(5,'Truck (Regular Cab)'),(7,'Truck (SuperCab)'),(6,'Truck (SuperCrew)'),(3,'Wagon');
...
INSERT INTO `vehicle` VALUES (1,1,1,1,1,1,1,1,'WBAAR3346YJB35144',10,41450.00,2022),(2,2,1,1,2,2,2,1,'WBAAG1107B7071594',15,56700.00,2022),(3,1,1,2,3,1,1,1,'WB10416A01ZC60664',15000,40750.00,2020),(4,1,1,3,4,1,1,1,'WBAVC53597F280348',24000,34900.00,2018),(5,1,1,3,5,2,2,1,'WBASP2C58BC337294',25000,48950.00,2018),(6,1,1,4,6,1,1,1,'5UXZW0C51BL657600',43000,33150.00,2016),(7,1,1,4,7,2,2,1,'WBABB2304KEC18748',44324,45800.00,2016),(8,1,1,5,4,1,1,1,'WBAEA8104C8160045',51000,32750.00,2014),(9,1,1,5,1,2,2,1,'WBSNB93526CX06186',54000,45400.00,2014),(10,3,1,6,2,1,1,1,'WBAVM1C58FVZ94090',56789,41450.00,2014),(11,1,1,6,8,1,1,2,'WBS6C9C50F0010137',45678,34900.00,2012),(12,1,1,7,5,2,2,2,'WBA1A1101FP627759',56123,42400.00,2012),(13,3,1,7,7,2,2,2,'WBA1K5C54FV473864',76543,37500.00,2012),(14,4,1,2,8,2,2,1,'WBAEP33403PE91635',16000,54000.00,2020),(15,5,2,8,9,3,3,3,'1FTPX27W8XNC05837',100,30495.00,2022),(16,6,2,8,10,4,1,3,'1FDTF4GT0FEC04565',150,62070.00,2022),(17,7,2,8,11,5,3,3,'1FAPP37U0RK147737',240,52360.00,2022),(18,5,2,9,12,3,3,4,'NM0GE9F71E1140792',12345,28745.00,2020),(19,7,2,9,13,3,3,4,'1FTHS34L5FHB78984',23456,32830.00,2020),(20,6,2,9,14,3,3,4,'1ZVLT22B0P0016902',31234,35285.00,2020),(21,5,2,10,15,6,3,4,'3FA6P0HR4DR275908',76543,26030.00,2015),(22,7,2,10,16,6,3,4,'1FMDU32E0XUB16328',81234,30090.00,2015),(23,6,2,10,17,6,3,4,'1FT8X3A66FEA17593',34899,32545.00,2015),(24,8,3,11,18,7,1,5,'JTECB09J823005642',135,25075.00,2022),(25,1,3,12,19,7,1,5,'4T1BG12K7TU071892',178,24325.00,2020),(26,1,3,13,20,7,1,5,'JT4RN81A5L5058840',10234,23475.00,2018),(27,9,3,14,21,8,1,5,'2T1LR38E13C094100',12098,19995.00,2003),(28,9,3,15,18,8,1,5,'JTEBU3FJ3E5048175',54198,19995.00,2002),(29,8,3,11,20,8,1,5,'5TFAW5F13FX422831',78103,19995.00,2001),(30,9,18,16,2,4,3,5,'JF1SG63685H737629',5,27360.00,2023),(31,7,18,17,8,5,4,6,'2HGEJ6617YH561116',8,39700.00,2023),(32,1,18,18,5,4,3,5,'1N6AD0EV9BC405351',2,26385.00,2023),(33,5,18,19,7,3,3,6,'2T1BU4EE4AC381738',10,39914.00,2023),(34,3,17,20,3,2,5,4,'1G8JW54RX3Y520537',18000,41700.00,2021),(35,1,17,22,5,2,5,4,'1FMJU1J5XAEA76057',26000,19635.00,2019),(36,8,17,23,9,2,5,2,'4S4BRCDC2E3267937',53000,12151.00,2014),(37,9,17,21,12,2,5,2,'JM1BJ245221484094',21000,15991.00,2019),(38,9,9,24,12,2,5,4,'4T4BF1FK1ER374026',10,29745.00,2023),(39,9,9,25,16,2,5,2,'1FMZU63W72ZB66847',9000,24495.00,2021),(40,9,9,26,18,2,5,2,'1GKKRRED3BJ228168',12000,46900.00,2020);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `commissionCheck`(IN employeeNum INT, INOUT commission varchar(4000))
BEGIN 
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `saleview` AS select concat(`c`.`firstName`,' ',`c`.`lastName`) AS `Customer Name`,concat(`c`.`address`,' ',`cs`.`city`,' ',`cs`.`state`,' ',`c`.`zipCode`) AS `Customer Address`,`c`.`phone` AS `Customer Phone`,`c`.`email` AS `Customer Email`,concat(`e`.`firstName`,' ',`e`.`lastName`) AS `Sales Associate`,`e`.`phone` AS `Sales Associate Phone`,`e`.`email` AS `Sales Associate Email`,`v`.`year` AS `Year`,`ma`.`make` AS `Make`,`mo`.`model` AS `Model`,`co`.`color` AS `Color`,`ty`.`type` AS `Type`,`v`.`vin` AS `VIN`,`s`.`salePrice` AS `Sale Price` from ((((((((`customer` `c` join `employee` `e`) join `citystate` `cs`) join `vehicle` `v`) join `make` `ma`) join `model` `mo`) join `color` `co`) join `type` `ty`) join `sale` `s`) where ((`c`.`zipCode` = `cs`.`zipCode`) and (`v`.`make` = `ma`.`ID`) and (`v`.`model` = `mo`.`ID`) and (`v`.`color` = `co`.`ID`) and (`v`.`type` = `ty`.`ID`) and (`v`.`retail` = `s`.`salePrice`) and (`c`.`ID` = `s`.`customerID`) and (`e`.`ID` = `s`.`employeeID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-12-04  1:36:02
